...
if(process.platform === 'darwin') {
  ...
  module.exports.isMuted = () => getInfo().then(info => info.muted);
  module.exports.mute = () => getDefaultDevice().then(defaultDevice => amixer('set', defaultDevice, 'mute'));
  module.exports.unmute = () => getDefaultDevice().then(defaultDevice => amixer('set', defaultDevice, 'unmute'));
}
